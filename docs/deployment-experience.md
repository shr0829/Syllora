...
LEARNING_IMAGE_CHANNEL_2_TYPE=newapi_channel_conn
LEARNING_IMAGE_CHANNEL_2_BASE_URL=https://xcode.best
LEARNING_IMAGE_CHANNEL_2_API_KEY=你的备用 image key
LEARNING_IMAGE_CHANNEL_2_MODEL_ID=gpt-image-2
```
